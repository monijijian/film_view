...
# 基本表
class BaseModelMaoyan(models.Model):
    id = models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='电影ID')
    film_name = models.CharField(max_length=255, null=True, verbose_name='电影名字')
    box_office = models.IntegerField(default=0, null=True, verbose_name='票房')
    box_office_scale = models.IntegerField(default=0, null=True, verbose_name='票房占比')
    file_schedule_scale = models.IntegerField(default=0, null=True, verbose_name='排片占比')

    class Meta:
        abstract = True

class Maoyan(BaseModelMaoyan):
    #将猫眼信息添加到已有的表中
    seat_scale = models.IntegerField(default=0, null=True, verbose_name='排座占比')

    class Meta:
        db_table = 'A_Maoyan_Table'
        verbose_name = '电影列表'
        verbose_name_plural = verbose_name